...
setup(
    ...
    keywords='mkdocs_strapi_plugin',
    name='mkdocs_strapi_plugin',
    packages=find_packages(include=['mkdocs_strapi_plugin', 'mkdocs_strapi_plugin.*']),
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/enecode/mkdocs_strapi_plugin',
    version='0.1.0',
    zip_safe=False,
)
